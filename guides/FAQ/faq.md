...
Gardez bien en tête que **pendant le déroulement d'une carrière, toutes vos stats sont secrètement boostées** (vous pouvez faire une approximation de environ +400 all stats). Je n'en ferai pas mention, car ce boost disparaît automatiquement une fois la carrière terminée. À vous d'ajouter +400 ou pas dans votre tête&, selon que vous lisez ces informations pendant ou hors d'une carrière.
