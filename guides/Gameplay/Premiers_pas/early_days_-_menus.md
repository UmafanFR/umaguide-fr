...
Une indication rapide et non-exhaustive de l'utilité des différents menus, afin de vous y retrouver plus facilement. Vous n'avez pas forcément besoin de lire toute cette partie maintenant, vous pourrez y revenir plus tard, et [passer directement à la suite.](04_early_days_-_career)
...
- **Career**. Ici vous allez pouvoir jouer une carrière d'une umamusume de votre choix, en utilisant vos cartes de support. À la fin de votre carrière, vous aurez une "build" de votre uma, en tant que "Veteran", et vous pourrez la faire participer à des courses *hors* de la carrière.
...
- **Club**. Vous pouvez y accéder à partir du **Team Rank E3**. Un club vous permet d'échanger des chaussures (utilisées pour débloquer les skills gold de vos uma) et de gagner chaque mois au moins 300 carats, et jusqu'à 3000 par mois pour les clubs les plus actifs.
...
- **Scout**. ~~Gacha was a mistake~~ Utilisez des carats pour obtenir des nouvelles cartes support, ou recrutez des nouvelles umamusume. C'est dans ce menu que vous pourrez utiliser les **tickets uma/support gold**, ainsi que les **tickets uma/support rainbow _aléatoire_**. On y revient dans un instant
...
- **Trainee**. La liste complète de toutes vos umamusume jouables. Quand vous avez assez de Star Pieces pour en débloquer une nouvelle (via des évènements comme les Legend Race), ce bouton aura un fer à cheval rouge pour vous l'indiquer. Chaque ★ supplémentaire au-delà de ★★★ n'est qu'une petite upgrade (même pour les uma ★★★ natives), donc ne vous sentez pas obligé de les monter ★★★★★ rapidement. C'est un beau trophée pour vos uma fav cela dit 😌
- **Star Pieces Storage**. Ici vous pouvez échanger des Star Pieces contre des clovers. Il est **fortement déconseillé** d'échanger des Star Pieces contre des clovers, pour des uma que vous n'avez pas encore en version ★★★★★, car **les clovers sont juste une monnaie particulièrement peu utile**.
...
Étant donné que le level max des cartes R, SR et SSR est différents en fonction des LBs, il est généralement plus facile de suivre une conversation quand **on parle de LB plutôt que de niveau**. Si je vous dit que ma carte support de Nishino Flower power est lvl 45, vous ne savez pas si elle est MLB (Max Limit Break) ou 3LB, car je n'ai pas précisé la rareté, ce qui vous empêche d'estimer les bonus qu'elle peut avoir. Si je vous dis par contre que ma Nishino Flower est 3LB, vous savez qu'elle est proche de son potentiel maximum, sans avoir à se dire "c'est une SR donc elle est MLB" ou "c'est une SSR donc elle est 3LB". Parler du LB d'une carte support donne bien plus d'infos sur la carte que son level.

Sauf quand la carte n'est pas max lvl, **mais elle devrait toujours l'être** :9

(oui je sais on est tous en galère de ressources en ce moment, ça ne durera pas très longtemps)

:::

- **Deck**. Vous pouvez inspecter et réorganiser vos decks. La carte en emprunt ne s'y affiche pas, donc honnêtement je viens jamais ici :9
- **Storage**. Ici vous pouvez échanger vos doublons de cartes supports **en excès**, contre des fers à cheval (argentés, dorés ou rainbow, selon la rareté de la carte échangée), qui peuvent -eux- être échangés contre divers items utiles (comme des tickets ou des Dream Glimmer). Vous pouvez sereinement échanger vos cartes R si vous le souhaitez, et ce même si vous ne les avez pas MLB, car vous ne vous en servirez que rarement (Rudolf R a un usage). Mais par PITIÉ, **n'échangez pas vos cartes SR en doublon tant que vous ne les avez pas MLB**. Et encore moins les cartes SSR, **même gratuites**. Un peu choqué d'avoir à le dire mais bon.
- **List**. La liste complète de toutes vos cartes support, toutes rareté confondues. Vous avez accès à plusieurs filtres pour les ordonner et classer de manière commode. S'il vous plait, quand vous demandez de l'**aide pour y voir plus clair dans votre collection de cartes support**, affichez les DANS CE MENU, et pas dans Level up/Uncap 👌🏿
...
- Autant que possible, **favorisez les 10-pulls** quand vous voulez pull une bannière. Un 10-pull vous garantis au moins 1 ★★/SR, et comme il ne peut pas y avoir de ★/R sur le 10e pull, c'est aussi un pull qui a de pl**us grandes chances de devenir ★★★/SSR**.
- Autant que possible, si vous commencez des pulls sur une bannière de **cartes support**, essayez -dans la limite du raisonnable- de **spark la bannière**. C'est à dire, monter jusqu'à 200 pulls (30k carats) avant la fin de la bannière, afin de pouvoir obtenir une **copie supplémentaire d'une des cartes support en highlight** (même si vous l'aviez déjà obtenu pendant vous pulls), de manière **garantie**. À moins que vous n'ayez eu la/les cartes MLB en très peu de pulls (ça arrive 🌟), spark la bannière vous apportera presque toujours une belle valeur ajoutée (en plus des autres SR et SSR que vous aurez pull pendant le process).
...
### Dans la prochaine partie, on commencera enfin [vos premières carrières](04_early_days_-_career).