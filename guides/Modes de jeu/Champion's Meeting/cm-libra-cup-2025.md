---
title: Champion's Meeting - Libra Cup 11 Décembre 2025 - Kikua Sho
...
Inscriptions et choix de league à partir de **lundi 8 décembre 2025**

Début de l'évènement **jeudi 11 décembre 2025** (évidemment je vais me planter d'un jour, comme d'hab :currenDevilish:)

:::


[![Visualisation de la course complète, comme affiché sur Gametora.com](/public/assets/Comp-PvP/CM06/CM06_Gametora_Race_Full.png)](/assets/Comp-PvP/CM06/CM06_Gametora_Race_Full.png)
...
- 🇬🇧 Visualisation de la course sur [sur Gametora](https://gametora.com/umamusume/racetracks/kyoto#3000-turf-outer)
...
La course est similaire en de nombreux points au **Tenno Sho Spring -Gemini Cup-**, si vous avez la giga flemme vous pouvez _envisager_ de réutiliser vos aces de la Gemini. Ce ne sera pas idéal, mais très certainement suffisant pour aller en Finale en Group B ! 
...
## La course - Kikuka Sho

La course étant longue de 3000m, la durée d'activation des skills et leur cooldown sont **multipliés par 3**. 
...
| --- | --- | --- | --- |
| Surface turf |  |  |  |
| Hippodrome de Kyoto | Kyoto Racecourse (stamina) | Rice Shower (power SSR ou direct la uma) // Mejiro McQueen stam SSR // Mejiro Dober (wits SSR et SR) |  |
| Distance 3000m | Non-Standard Distance (stamina) | Mayano Top Gun stam SR // Manhattan Cafe stam SR (event) |  |
| Sens horaire | Right Handed (speed) | Fine Motion wits SSR, Narita Brian speed SSR // Matikanefukukitaru wits SR (2nd chain event → option du bas) // Zenno Rob Roy speed SSR (2nd chain event → option du haut) |  |
| Saison automne | Fall Runner (speed) | Fine Motion wits SSR |  |
...
⏬ Visualisation de la course [sur Gametora.com](https://gametora.com/umamusume/racetracks/Kyoto#3000-turf-inner).
...
| Uma | Stamina | Recovries (% de soin) | Survie ? |
| --- | --- | --- | --- |
| Pace | 1200 | 1 gold (5,5%) | Oui |
| Super Creek (Pace) | 1100 | Son unique (7,5%) | Oui |
| Pace | 1050 | 1 gold + 1 "super-white" (9%) | Oui |
| Pace | 950 | 2 gold (11%) | Oui |
| Pace | 725 | 3 gold (16,5%) | Oui |
...
⏩ Voici une liste -que j'espère exhaustive- des recovery pertinentes et non exclusives à une uma. S'il n'y a pas de "note" c'est que le skill est fiable.

| Skill | Source pertinente | Pour qui ? | Soin (% de HP) | Note | 
| --- | --- | --- | --- | --- |
...
| Race Planner | Daiwa Scarlet power SSR | Pace | 5,5% | Pertinent si vous voulez tenter une build avec plusieurs cartes power au lieu de plusieurs stam (Super Creek, Rice Shower alt, ou autre uma avec plein de recovery) |
| Lie in Wait | Zenno Rob Roy speed SSR | Late | 5,5% | Fiable la vaste majorité du temps |
| Superior Heal | Grass Wonder alt (inspiration) | Backlines | 3,5% |  |
| Adrenaline Rush | No | No | No | Je l'inclus dans la liste juste pour que vous sachiez que c'est toujours de la merde |
...
| Resplendent Red Ace | Tenter de dépasser la uma en 1e position, après 50% de la course (ou être en 1e position et avoir quelqu'un juste derrière) | Daiwa Scarlet | Pace et Front | Pas hyper prio, c'est surtout pour elle principalement. Chance d'activation optimale avec accel moyenne, assez bonne chance de carry over. |
...
Bon courage tout le monde pour votre préparation au Champion's Meeting ! Pour rappel, vous pouvez vous **inscrire au CM** et choisir votre **league** à partir du **lundi 8 décembre !** 
